...
int ddcci_readctrl(struct monitor* mon, unsigned char ctrl, 
 ...
 int ddcci_raw_writectrl(struct monitor* mon,  unsigned char *buf, unsigned char len);
 int ddcci_raw_readctrl(struct monitor* mon, unsigned char ctrl, unsigned char *buf, unsigned char len);
