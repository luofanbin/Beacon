...
void QSpotlightSetting::ControlLayout()
{
    ...
    mainLayout->addLayout(HBoxLayout,4,0,1,1);
...
void QSpotlightSetting::setSpotlightColor()
{
    ...
    *mp_colorSpotlight = QColorDialog::getColor(*mp_colorSpotlight, this,
                                          strColorDialogName,
...
void QSpotlightSetting::setLasterpenColor()
{
    ...
    if(mp_colorLasterpen!=NULL)
        *mp_colorLasterpen = QColorDialog::getColor(*mp_colorLasterpen, this,
                                              strColorDialogName,
                                              QColorDialog::ShowAlphaChannel);
    //m_colorSpotlight=QColor(255,0,0);
    showColorButton();
...
void QSpotlightSetting::setWatordropColor()
{
    ...
    if(mp_colorFindMouse!=NULL)
          *mp_colorFindMouse = QColorDialog::getColor(*mp_colorFindMouse, this,
                                              strColorDialogName,
                                              QColorDialog::ShowAlphaChannel);
    //m_colorSpotlight=QColor(255,0,0);
    showColorButton();
