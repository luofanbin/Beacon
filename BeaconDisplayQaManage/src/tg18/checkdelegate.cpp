...
void CheckBoxDelegate::paint(QPainter* painter, const QStyleOptionViewItem& option,const QModelIndex& index)const
{
    ...
    if(index.column() == 3 |index.column() == 9){
        ...
        checkBoxStyleOption.palette.setBrush(QPalette::Base,QBrush(QColor(Qt::green)));
        checkBoxStyleOption.palette.setColor(QPalette::Background,QColor(Qt::green));

    //   pButton->setStyleSheet("background-color: rgb(255,255,0);");
       // checkBoxStyleOption.styleObject->setProperty()
